    ...
    <div className="mt-10 text-white flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Name</span>
            ...
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Nationality</span>
                <div className="flex gap-3">
                    <span className="text-light">:</span>
            ...
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Phonw</span>
                <div className="flex gap-3">
                    <span className="text-light">:</span>
            ...
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Email</span>
                <div className="flex gap-3">
                    <span className="text-light">:</span>
            ...
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Experience</span>
                <div className="flex gap-3">
                    <span className="text-light">:</span>
            ...
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Skype</span>
                <div className="flex gap-3">
                    <span className="text-light">:</span>
            ...
            <div className="flex text-lg">
                <span className="text-light w-[130px] shrink">Language</span>
                <div className="flex gap-3">
                    <span className="text-light">:</span>
